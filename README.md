...
📚 详细的项目代码规范和样式使用规范请查看 [CODE_STANDARDS.md](./CODE_STANDARDS.md)

该文档包含：
- 代码编写规范（ESLint、TypeScript、命名规范等）
- 样式使用规范（TailwindCSS、响应式设计、颜色规范等）
- 组件开发规范（组件结构、Props、Emits 等）
- 文件组织规范（目录结构、命名规范、路径别名等）
- 最佳实践（性能优化、可维护性、错误处理等）
